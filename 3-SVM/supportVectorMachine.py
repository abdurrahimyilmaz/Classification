...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 28 13:48:17 2020

@author: abdurrahim
"""

#sınırların çok yakın olduğu yerlerde çok iyi sonuçlar veriyor
#normalde iki veriyi bir sürü farklı çizgiyle ikiye ayırabiliriz ama bu yöntemle aralarındaki  en yakın iki noktaya max eşit mesafeyi baz alan
#bir çizgiyle ayırıyoruz yani hyperplane ile
...
x = dataset.iloc[:, [2,3]].values #matrixs
...
classifier = SVC(kernel = 'rbf', random_state = 0) #sadece buradaki kernel değişiyor
