...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 27 22:15:55 2020

@author: abdurrahim
"""

#linear regresyonda y yerine sigmoid funksiyonun ysi koyulur = logistic regression
#mail sınıflandırma felen bu yolla yapılabiliyor
#sigmoid fonksiyonunda 0.5 altı 0a üstü 1e yuvarlanır asıl mantık bu
#lr bir lineer classifierdır
...
#fitting lg to training test
from sklearn.linear_model import LogisticRegression
classifier = LogisticRegression(random_state = 0) #sürekli aynı sonucu almak için random = 0
